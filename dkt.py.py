...
def main():
    ...
    # create LSTM
    model = Sequential()
    model.add(LSTM(n_neurons, input_shape=(6, 1), return_sequences=True))
    ...
    #model.add(keras.layers.TimeDistributedDense(input_dim = hidden_units, 
       # output_dim = num_skills, activation='sigmoid'))
    
    #model.add(TimeDistributed(Dense(1))
    #model.add(input_dim = hidden_units)
    #model.add(activation = 'sigmoid'))
    #model.add(Embedding(output_dim = num_skills))
    #model.add(Activation('sigmoid'))
